...
exports.createRating = async (req, res) => {
  try {
    ...
    if (!courseDetails) {
      // console.log("courseDetailsError ::: " , courseDetails)
...
exports.getAverageRating = async (req, res) => {
  try {
    ...
    // const newCourseId = mongoose.Types.ObjectId.createFromHexString(courseId)
    // console.log("courseId from server Mongoose Converted ID : " , newCourseId)
